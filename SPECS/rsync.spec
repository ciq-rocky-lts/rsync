...
Patch9: rsync-3.2.5-cve-2026-43620.patch
# CVE-2026-45232 — upstream backport
Patch10: rsync-3.2.5-cve-2026-45232.patch
# CVE-2026-43617 — upstream backport
Patch11: rsync-3.2.5-cve-2026-43617.patch
# CVE-2026-43618 — upstream backport
Patch12: rsync-3.2.5-cve-2026-43618.patch
# CVE-2025-10158 — upstream backport
Patch13: rsync-3.2.5-cve-2025-10158.patch
# CVE-2026-29518 — upstream backport
Patch14: rsync-3.2.5-cve-2026-29518.patch
# CVE-2026-43619 — upstream backport
Patch15: rsync-3.2.5-cve-2026-43619.patch
# CVE-2024-12086 — upstream backport
Patch16: rsync-3.2.5-cve-2024-12086.patch
# CVE-2026-41035 — upstream rsync bb0a8118 (2-line fix, clean apply)
Patch17: rsync-3.2.5-cve-2026-41035.patch
...
%patch9 -p1 -b .cve-2026-43620
%patch10 -p1 -b .cve-2026-45232
%patch11 -p1 -b .cve-2026-43617
%patch12 -p1 -b .cve-2026-43618
%patch13 -p1 -b .cve-2025-10158
%patch14 -p1 -b .cve-2026-29518
%patch15 -p1 -b .cve-2026-43619
%patch16 -p1 -b .cve-2024-12086
%patch17 -p1 -b .cve-2026-41035
...
%changelog
* Wed May 20 2026 Jason Rodriguez <jrodriguez@ciq.com> - 3.2.5-3.1
- Fix CVE-2026-43620
- Fix CVE-2026-45232
- Fix CVE-2026-43617
- Fix CVE-2026-43618
